@extends('layouts.contributorMenu')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/contributor/manage/blog/save" method="post" id="newBlogForm" enctype="multipart/form-data">
                    {{csrf_field()}}
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
    ...
    <div class="modal fade" id="editBlogInfoModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/contributor/manage/blog/save" method="post" id="editBlogForm" enctype="multipart/form-data">
                    {{csrf_field()}}
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
    ...
    <script>
        ...
        $(document).on("click", "#insertButton", function(){
            if($("#newBlogForm").valid()){
                $.ajax({
                    type: "POST",
                    url: "/contributor/manage/blog/save",
        ...
        $(document).on("click", "#updateButton", function(){
            ...
            if($("#editBlogForm").valid()){
                $.ajax({
                    type: "POST",
                    url: "/contributor/manage/blog/update?id="+id,
        ...
        $(document).on("click", "#btnDelete", function(){
            ...
            $.ajax({
                type: "GET",
                url: "/contributor/manage/blog/delete?id="+id,
                success: function (da) {
                    var table = $("#blogList").DataTable();
                    table.destroy();
                    getBlogList();
        ...
        function getBlogList(){
            var table = $("#blogList").DataTable({
                ajax:{
                    url: "/contributor/manage/blog/retrieve",
                    dataSrc: "",
                },
                columns: [
                    {
